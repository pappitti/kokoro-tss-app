    ...
    return (
      <div className="mt-6">
        <div className="flex justify-between items-center mb-3">
          <h3 className="text-lg font-medium">Streaming Results</h3>
          <div className="flex space-x-2">
            ...
            <button
              ...
              className="px-2 py-1 text-xs text-white border border-indigo-600 rounded hover:bg-indigo-50"
              disabled={streamingAudio.length === 0}
            >
              Download All
            </button>
        ...
        <div className="space-y-4 max-h-96 overflow-y-auto p-2">
          {streamingAudio.map((item, index) => (
            <div 
              key={index} 
              className={`bg-gray-50 dark:bg-zinc-700 rounded-lg p-3 transition-all duration-300 ${
  ...
  return (
    <div className="flex flex-col w-full h-full">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-gray-100 dark:bg-zinc-700 px-6 py-3 rounded-lg">
        ...
        <div className="mt-3 py-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              <div className="lg:col-span-2">
                ...
                <div className="mb-6">
                  <div className="mt-1 relative">
                    ...
                    />
                    <div className="absolute bottom-2 right-2 text-xs  dark:text-gray-400">
                ...
                {audioUrl && !settings.streaming && (
                  <div className="mt-6 p-4 bg-gray-50 rounded-lg dark:bg-zinc-700">
                    <label className="text-sm font-medium mb-2">Generated Audio:</label>
                    <audio 
                      ref={audioRef}
                      controls 
                      className="w-full"
              ...
              <div>
                {/* Settings Panel */}
                <div className="bg-gray-100 rounded-lg p-4 dark:bg-zinc-700">
                  ...
                  {/* Data Type Selection */}
                  <div className="mb-4">
                    <label htmlFor="dtype-select" className="block text-sm font-medium mb-1">
                      Precision
                    </label>
                    <select
                      id="dtype-select"
                  ...
                  <div className="mb-4">
                    ...
                    <div className="flex items-center gap-2">
                      <span className="text-xs  dark:text-gray-400">0.5</span>
                      <input
                        id="speed-slider"
                        type="range"
                        min="0.5"
                  ...
                  <div className="mb-4">
                    <div className="flex items-center">
                      ...
                      />
                      <label htmlFor="streaming-toggle" className="ml-2 block text-sm">
                        Enable Streaming
                      </label>
                    </div>
                    <p className="text-xs text-gray-500 mt-1 dark:text-gray-400">
                  ...
                  {/* Reset Button */}
                  <button
                    className="w-full mt-4 py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-white bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                    onClick={() => {
                  ...
                  {/* Reload Model Button */}
                  <button
                    className="w-full mt-2 py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-white bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                    onClick={() => {
